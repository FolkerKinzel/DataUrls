...
public static class StringBuilderExtension
{
    ...
    public static StringBuilder AppendDataUrl(this StringBuilder builder,
        ...
        => DataUrl.AppendTextTo(builder, text, mimeType, dataEncoding);
    ...
    public static StringBuilder AppendDataUrl(this StringBuilder builder,
        ...
        => DataUrl.AppendBytesTo(builder, bytes.AsSpan(), mimeType, dataEncoding);
    ...
    public static StringBuilder AppendDataUrl(this StringBuilder builder,
        ...
        => DataUrl.AppendBytesTo(builder, bytes, mimeType, dataEncoding);
    ...
    public static StringBuilder AppendDataUrl(this StringBuilder builder,
                                                      ...
                                                      DataEncoding dataEncoding = DataEncoding.Base64)
        => DataUrl.AppendBytesTo(builder, bytes.AsSpan(), in mimeType, dataEncoding);
    ...
    public static StringBuilder AppendDataUrl(this StringBuilder builder,
                                              ...
                                              in MimeTypeInfo mimeType,
                                              DataEncoding dataEncoding = DataEncoding.Base64)
        => DataUrl.AppendBytesTo(builder, bytes, in mimeType, dataEncoding);
    ...
    public static StringBuilder AppendFileAsDataUrl(this StringBuilder builder,
                                                    ...
                                                    DataEncoding dataEncoding = DataEncoding.Base64)
        => DataUrl.AppendFileTo(builder, filePath, mimeType, dataEncoding);
    ...
    public static StringBuilder AppendFileAsDataUrl(this StringBuilder builder,
                                                     ...
                                                     in MimeTypeInfo mimeType,
                                                     DataEncoding dataEncoding = DataEncoding.Base64)
        => DataUrl.AppendFileTo(builder, filePath, in mimeType, dataEncoding);
